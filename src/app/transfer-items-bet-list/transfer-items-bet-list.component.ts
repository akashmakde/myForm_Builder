...
@Component({
  selector: 'app-transfer-items-bet-list',
  templateUrl: './transfer-items-bet-list.component.html',
  styleUrls: ['./transfer-items-bet-list.component.scss']
})
export class TransferItemsBetListComponent implements OnInit {
